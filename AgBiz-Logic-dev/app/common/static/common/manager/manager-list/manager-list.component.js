(function() {
  ...
  angular
    ...
    .component("managerList", {
      templateUrl: "/static/common/manager/manager-list/manager-list.component.html",
      controller: ManagerListComponentController,
      bindings: {
        itemList: "<",
        editable: "<",
        type:"<",
  ...
  ****************************************************************/
  ...
  ManagerListComponentController.$inject = [];

  function ManagerListComponentController() {
    var $ctrl = this;
    ...
    ****************************************************************/
    ...
    function initialize() {
      ...
      if($ctrl.shortcutpdf === undefined){
        $ctrl.shortcutpdf = false;
      }
      console.log($ctrl.shortcutpdf)
    }
