(function() {
  ...
  angular
    ...
    .component("planInventory", planInventory());

  function planInventory() {
    var component = {
      templateUrl: "/static/scenario/plan-inventory/plan-inventory.component.html",
      controller: PlanInventoryComponentController,
    };
  ...
  ****************************************************************/
  ...
  PlanInventoryComponentController.$inject = [
    'commonService',
    'scenarioService',
    'budgetService',
    '$state',
  ...
  function PlanInventoryComponentController(
    commonService,
    scenarioService,
    budgetService,
    $state,
    ...
    function $onInit() {
      ...
      $ctrl.module = $state.params['module'];
        ...
        .then(function(user_response) {
          ...
          return scenarioService.listPlans($ctrl.user.username, "all", ["id", "title", "notes", "created_date", "modified_date"]);
        })
