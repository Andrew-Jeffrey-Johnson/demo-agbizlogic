(function() {
  ...
  describe("Scenario Discount Rate Component", function() {
    var $scope,
        $q,
        $state,
        commonServiceMock,
    ...
    beforeEach(inject(function($injector) {
      ...
      controller = $componentController("scenarioDiscountRate", {
    ...
    describe("proceed", function () {
      ...
      it("goes to scenario summary state with scenario id in state parameters", function () {
        controller.proceed();
        $scope.$digest();
