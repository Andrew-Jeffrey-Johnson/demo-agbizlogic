(function() {
  ...
  describe("Scenario Summary Component", function() {
    ...
    beforeEach(inject(function($injector) {
      ...
      controller = $componentController("scenarioSummary", {
    ...
    describe("back", function () {
      ...
      it("goes to scenario discount rate state with scenario id in state parameters", function () {
        controller.back();
        $scope.$digest();

        expect($state.go.calls.argsFor(0)).toEqual(["scenarioDiscountRate", {
          'scenario': controller.scenario.id, 'module':module
        }]);
      });
