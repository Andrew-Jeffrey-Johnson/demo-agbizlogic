...
-run ' pip install -r requirements.txt ' (change pip to pip3 if you have both versions of pip installed)
-run ' npm install '
-run the first time setup script ' entrypoint.sh '
...
To start the server again in the same environment you can run the command, ' python3 manage.py runserver ' from the app directory where manage.py is located.
